...
provenance -- commercial wall textures, a licensed cat model, photographic
...
| `boom_py` | NPC sprites (3 monsters) | Monster Builder Pack |
| `boom_py` | weapon + impact sounds | Retro Sounds 1, Impact Sounds |
| `boom_py` | music | Music Loops |
...
| `boom_py` | 5 tiling brick wall textures | `tools/make_boom_assets.py` |
| `boom_py` | sky, HUD digits, overlays | `tools/make_boom_assets.py` |
| `boom_py` | weapon frames, lights, scenery | `tools/make_boom_assets.py` |
...
`boom_py` and `threepy` are ports of community tutorial projects, rewritten
